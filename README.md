...
# Setup
I made this code capable of using either sblens virtual enviorment, but if you either don't have sblens or want to save some compute time, run the following command: 
